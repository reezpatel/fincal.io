...
const (
	UserService_Self_FullMethodName           = "/fincal.UserService/self"
	UserService_UpdateSelf_FullMethodName     = "/fincal.UserService/updateSelf"
	UserService_UpdatePassword_FullMethodName = "/fincal.UserService/updatePassword"
)
...
func (c *userServiceClient) Self(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) Self(context.Context, *emptypb.Empty) (*UserResponse, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fincal.UserService",
